...
export const adminNavGroups: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "googleReviews", label: "Google Reviews", href: "/admin/google-reviews", permission: "reviews.view" },
  ...
  },
  {
    ...
    children: [
      ...
      { key: "appointments", label: "طلبات حجز موعد", href: "/admin/appointments", permission: "appointments.view" },
